<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="TallerWeb.login" %>
                ...
                <div class="login-box-body">
                    ...
                    <form action="../../index2.html" method="post">
                        ...
                        <div class="row">
                            <!-- /.col -->
                            <div class="col-xs-12">
                                <asp:Button ID="validaUsuario" runat="server" Text="Ingresar" class="btn btn-primary btn-block btn-flat" OnClick="validarUsuario_Click" />
                            </div>                            
                            <!-- /.col -->
                        </div>
                    </form>
